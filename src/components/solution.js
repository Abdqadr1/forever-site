    ...
    <div className="solution">
        ...
        <p className="finally-exposed"><span className="bigger-text red-text">"FINALLY EXPOSED: </span>The Ancient Secret That Gives YOU A Proven, Permanent & All-<span>Natural Cure For Erectile Dysfunction,
         ...
         <p className="left urge"><span>This is why I urge you to block out all distractions and give me your undivided attention.</span><span>This really is THAT important...</span>
            ...
            <p>​Fortunately, You Can Put An End To The Shame Caused By Your Embarrassing Small Iroko, 
            ...
            <p>If Your ANSWER Is YES to Any of the Questions...  NOW, I'M READY TO SHARE THIS SECRET WITH YOU.</p>

            <h1>INTRODUCING...</h1>
            <p>BEE POLLEN AND MULTI MACA PRODUCTS. THESE ARE BEST NATURAL HERBAL SOLUTION FOR WEAK ERECTION, PREMATURE EJACULATION AND SMALL PENIS SYNDROME...</p>

            <p>It is a wonderful plant that is found in Peru. It has served as both food and Medicine for the Peruvians for Hundreds of Years.</p>

            <p>PERMIT ME TO BREAKDOWN THE COMPONENTS OF THIS WONDERFUL PRODUCTS SO THAT YOU CAN GET THE OPPORTUNITY TO SEE WHY IT IS DIFFERENT FROM ALL OTHER SUPPLEMENTS YOU MAY HAVE USED BEFORE AND SEE WHY YOU SHOULD GET YOURS TODAY.</p>

            <p>MULTI MACA & ALOE VERA HAS MANY BENEFITS</p>
            ...
            <p>ALOE GEL & MULTI MACA  is so much better at enhancing libido.</p>
            <IMAGE size="1" image={maleSperm} alt="Treating low count sperm" />

            <h1>TREATING MALE FERTILITY & LOW SPERM COUNT</h1>
            <p>Becomes more effective when combined with another Super Herbal Supplement called BEE POLLEN</p>
            ...
            <p>Then You will feel amazing!..knowing you have the power to deeply satisfy your wife, girlfriend or casual lovers and give her multiple orgasms </p>

            <p>Some Interesting Facts About BEE POLLEN &  MULTI MACA</p>
            <IMAGE size="1" image={multi_maca} alt="Multi Maca" />
            <p>MULTI MACA contains a large variety of vitamin, Including of 12 kind of vitamins :Vitamin A, C, B1, B2, B3, B5, B6, B12, E.

            Many of these vitamins cannot be stored by the body so we need consume of the any natural supplements that contains vitamin.

            ALEO VERA is Immune Support and Function: High levels of ingredients that the body needs to keep healthy life.

            Among the substances identified is BEE POLLEN a long chain sugar (polysaccharide) that is known to have an effect on the cytokine system – the chemical messengers of the immune system.

            MULTI MACA is also an Energizer, MACA promote good metabolism, that is the production of energy which the body needs. Also because it contains Vitamin C, that may be important in the strengthening of the immune system.

            It is a natural Cleanser, Forever Living ALEO VERA may cleanse our body system from the toxic substances, due to the oils it contains. On the other hand, because of the presence of proteolytic enzymes, it helps cleaning dead tissues.

            It can regenerate cells, BEE POLLEN possesses a hormone that may accelerate the growth of new cells, also eliminating the old ones.</p>
            ...
            <p>According to holistic health expert Dr. Joseph Mercola, BEE POLLEN & MULTI MACA has antibiotic-type properties that can help protect the body from contracting viruses. It’s also rich in antioxidants that protect the cells from the damaging oxidation of free radicals.</p>
            <ul>
            ...
            <p>WHEN YOU COMBINE BEE POLLEN + MULTI MACA  THE RESULT WOULD BE MASSIVE! JUST LIKE THIS</p>
            <IMAGE size="1" image={dildo} alt="dildo" />
            <p>ENJOY BIGGER, HARDER, PLUS MORE INTENSE ERECTIONS !</p>
            <p>With this two products, you enjoy bigger and harder erections! With these two products these are what you will experience.</p>
            <h1>WE ARE SURE YOUR PROBLEMS WOULD BE SOLVED.</h1>
            <IMAGE size="1" image={erectile} alt="erectile disorder" />
            <p>Guaranteed !!! Then you won’t need any other drugs or synthetic chemical based Viagra to help you. Our herbs are purely natural herbs for Impotence and the best Impotence natural remedies</p>
            <p>From today you are sure of the following…</p>
            <ul>
                <li>No more SEXUAL WEAKNESS even if you are old.</li>
                <li>Increases the interest in sexual activity naturally and very useful remedy for loss of libido.</li>
                <li>No more Premature Ejaculation.</li>
                <li>No more embarrassment on bed.</li>
                <li>No more guilt.</li>
                <li>No more emotional instability.</li>
                <li>You will increases stamina, enhance performance, increase energy, confidence and maintains your sex drive.</li>
            </ul>
            <h1>STARTER PACK</h1>
            <p>FOR WEAK AND PREMATURE EJACULATION TODAY'S PROMO PRICE FOR 2IN1</p>
            <h1>35,000</h1>
            <h1>25,000</h1>
            <IMAGE size="1" image={measure} alt="Bigger" />
            <p>INTERNATIONALLY CERTIFIED & NAFDAC APPROVED</p>
            <IMAGE size="1" image={cert} alt="Certified" />
            <IMAGE size="1" image={aloegel} alt="Aloe vera gel" />
            <p>ALOE VERA are very safe to use, even on short term basis. You gain erection when you are ready to have sex, no matter how frequent it is. You are naturally and sexually active. Due to there efficacy, NAFDAC put their trust on it and it is approved by them.</p>

            <h1>SUPER PACK</h1>
            <p>FOR WEAK AND PREMATURE EJACULATION & ENLARGEMENT</p>
            <h1>45,000</h1>
            <h1>35,000</h1>
            <Countdown />
