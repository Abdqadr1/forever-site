    ...
    return ( 
            <div className="form">
                ...
                <fieldset onSubmit={handleSubmit}>
                    ...
                    <p htmlFor="number">PHONE NUMBER <span className="red-text">*</span></p>
                    <input type="text" id="number"  name="number" value={formFields.number} required onChange={handleChange}/>
